                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-auto text-alabaster text-left">
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[10px] truncate font-medium hover:text-accent-dark transition-colors">
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[10px] truncate font-medium hover:text-accent-dark transition-colors flex items-center gap-0.5">
